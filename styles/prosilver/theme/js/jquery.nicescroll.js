...
//              self.doScrollTop(self.getScrollTop(true)+rt);
        ...
        if (self.opt.enablekeysrcrd) self.bind(document,(cap.isopera&&!cap.isopera12)?"keypress":"keydown",self.onkeypress);
...
//
      ...
      if (this.doc[0].nodeName == 'IFRAME') {
        function oniframeload(e) {
          ...
          if (self.opt.enablekeysrcrd) self.bind(doc,(cap.isopera)?"keypress":"keydown",self.onkeypress);
