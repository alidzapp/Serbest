...
class db
{
	...
	* @param	\src\config\config				$config			The src configuration
	* @param	\src\db\driver\driver_interface	$db				A database connection
	*/
	public function __construct($config_name, \src\config\config $config, \src\db\driver\driver_interface $db)
	{
