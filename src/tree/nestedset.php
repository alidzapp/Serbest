...
abstract class nestedset implements \src\tree\tree_interface
{
	...
	*/
	public function __construct(\src\db\driver\driver_interface $db, \src\lock\db $lock, $table_name, $message_prefix = '', $sql_where = '', $item_basic_data = array(), $columns = array())
	{
		$this->db = $db;
		$this->lock = $lock;
