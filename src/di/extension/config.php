...
class config extends Extension
{
	...
	public function __construct(\src\config_php_file $config_php)
	{
	...
	*/
	...
	{
		$parameters = array(
			'core.adm_relative_path'	=> $this->config_php->get('src_adm_relative_path') ? $this->config_php->get('src_adm_relative_path') : 'adm/',
			...
			'dbal.new_link'				=> defined('src_DB_NEW_LINK') && src_DB_NEW_LINK,
		);
	...
	*/
	protected function convert_30_acm_type($acm_type)
	{
		...
		{
			return 'src\\cache\\driver\\' . $acm_type;
		}
