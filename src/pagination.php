...
class pagination
{
	...
	* @param	\src\user							$user
	* @param	\src\controller\helper			$helper
	* @param	\src\event\dispatcher_interface	$src_dispatcher
	*/
	public function __construct(\src\template\template $template, \src\user $user, \src\controller\helper $helper, \src\event\dispatcher_interface $src_dispatcher)
	{
