...
class datetime extends \DateTime
{
	...
	*/
	...
	/**
	* @var array Date formats are preprocessed by src, to save constant recalculation they are cached.
	*/
	static protected $format_cache = array();

	/**
	* Constructs a new instance of \src\datetime, expanded to include an argument to inject
