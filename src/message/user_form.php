...
class user_form extends form
{
	...
	*/
	public function check_allow()
	{
		...
		if ($this->recipient_id == ANONYMOUS || !$this->config['srcrd_email_form'])
		{
			return 'NO_EMAIL';
		}
	...
	*/
	public function render(\src\template\template $template)
	{
		...
		$template->assign_vars(array(
			'S_SEND_USER'			=> true,
			'S_POST_ACTION'			=> append_sid($this->src_root_path . 'memberlist.' . $this->phpEx, 'mode=email&amp;u=' . $this->recipient_id),
