...
class message
{
	...
	*/
	...
	/**
	* Set the senders data from \src\user object
	*
	* @param \src\user $user
	* @return null
	*/
	...
	*/
	public function send(\messenger $messenger, $contact)
	{
		...
		foreach ($this->recipients as $recipient)
		{
			...
			$messenger->headers('X-AntiAbuse: srcrd servername - ' . $this->server_name);
