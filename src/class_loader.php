...
class class_loader
{
	...
	*/
	...
	/**
	* Creates a new \src\class_loader, which loads files with the given
	...
	*/
	public function __construct($namespace, $path, $php_ext = 'php', \src\cache\driver\driver_interface $cache = null)
	{
		if ($namespace[0] !== '\\')
		{
			$namespace = '\\' . $namespace;
	...
	*/
	...
	/**
	* Resolves a src class name to a relative path which can be included.
	*
