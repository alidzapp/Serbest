...
class event extends \Twig_Node
{
	...
	*/
	...
	public function __construct(\Twig_Node_Expression $expr, \src\template\twig\environment $environment, $lineno, $tag = null)
	{
	...
	*/
	public function compile(\Twig_Compiler $compiler)
	{
		...
		foreach ($this->environment->get_src_extensions() as $ext_namespace => $ext_path)
		{
