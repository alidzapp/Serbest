...
class extension extends \Twig_Extension
{
	...
	* Constructor
	*
	* @param \src\template\context $context
	* @param \src\user $user
	* @return \src\template\twig\extension
	*/
	public function __construct(\src\template\context $context, $user)
	{
	...
	*/
	...
	{
		return array(
			new \src\template\twig\tokenparser\defineparser,
			new \src\template\twig\tokenparser\includeparser,
			new \src\template\twig\tokenparser\includejs,
			new \src\template\twig\tokenparser\includecss,
			new \src\template\twig\tokenparser\event,
			new \src\template\twig\tokenparser\includephp,
			new \src\template\twig\tokenparser\php,
		);
	}
