...
class php_exporter
{
	...
	* @param mixed $extension	String 'vendor/ext' to filter, null for src core
	* @param string $min_version
	* @param string $max_version
	*/
	public function __construct($src_root_path, $extension = null, $min_version = null, $max_version = null)
	{
		$this->root_path = $src_root_path;
		$this->path = $src_root_path;
	...
	*/
	...
	/**
	* Crawl the src/ directory for php events
	* @return int	The number of events found
	*/
	public function crawl_src_directory_php()
	{
	...
	public function get_recursive_file_list()
	{
		try
		{
			$iterator = new \RecursiveIteratorIterator(
				new \src\event\recursive_event_filter_iterator(
	...
	*/
	...
	{
		return (!$this->min_version || src_version_compare($this->min_version, $version, '<='))
			&& (!$this->max_version || src_version_compare($this->max_version, $version, '>='));
	}
