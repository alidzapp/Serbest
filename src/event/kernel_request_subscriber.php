...
class kernel_request_subscriber implements EventSubscriberInterface
{
	...
	*/
	public function __construct(\src\extension\manager $manager, $root_path, $php_ext)
	{
	...
	*/
	public function on_kernel_request(GetResponseEvent $event)
	{
		...
		$matcher = src_get_url_matcher($this->manager, $context, $this->root_path, $this->php_ext);
