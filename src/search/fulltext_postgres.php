...
*/
class fulltext_postgres extends \src\search\base
{
	/**
	...
	public function __construct(&$error, $src_root_path, $phpEx, $auth, $config, $db, $user, $src_dispatcher)
	{
		...
		{
			include($src_root_path . 'includes/utf/utf_tools.' . $phpEx);
		}
	...
	*/
	public function keyword_search($type, $fields, $terms, $sort_by_sql, $sort_key, $sort_dir, $sort_days, $ex_fid_ary, $post_visibility, $topic_id, $author_ary, $author_name, &$id_ary, &$start, $per_page)
	{
		...
		*/
		...
		extract($this->src_dispatcher->trigger_event('core.search_postgres_keywords_main_query_before', compact($vars)));
