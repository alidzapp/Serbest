...
*/
class fulltext_mysql extends \src\search\base
{
	/**
	...
	/**
	 * Constructor
	 * Creates a new \src\search\fulltext_mysql, which is used as a search backend
	 *
	...
	*/
	public function init()
	{
		...
		$fulltext_supported =
			...
			$engine === 'InnoDB' &&
			src_version_compare($this->db->sql_server_info(true), '5.6.4', '>=');
