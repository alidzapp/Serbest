...
/**
* src's own db driven fulltext search, version 2
*/
class fulltext_native extends \src\search\base
{
	/**
	...
	*/
	public function __construct(&$error, $src_root_path, $phpEx, $auth, $config, $db, $user, $src_dispatcher)
	{
		...
		*/
		...
		{
			include($this->src_root_path . 'includes/utf/utf_normalizer.' . $this->php_ext);
		}
		if (!function_exists('utf8_decode_ncr'))
		{
			include($this->src_root_path . 'includes/utf/utf_tools.' . $this->php_ext);
		}
	...
	*/
	public function author_search($type, $firstpost_only, $sort_by_sql, $sort_key, $sort_dir, $sort_days, $ex_fid_ary, $post_visibility, $topic_id, $author_ary, $author_name, &$id_ary, &$start, $per_page)
	{
		...
		*/
		...
		extract($this->src_dispatcher->trigger_event('core.search_native_author_count_query_before', compact($vars)));
		...
		*/
		...
		do
		{
			...
			*/
			...
			{
				$conv_loaded[$idx] = 1;
				$file = $this->src_root_path . 'includes/utf/data/search_indexer_' . $idx . '.' . $this->php_ext;
