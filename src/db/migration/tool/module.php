...
*/
class module implements \src\db\migration\tool\tool_interface
{
	...
	*/
	public function __construct(\src\db\driver\driver_interface $db, \src\cache\service $cache, \src\user $user, $src_root_path, $php_ext, $modules_table)
	{
		$this->db = $db;
		$this->cache = $cache;
		$this->user = $user;
