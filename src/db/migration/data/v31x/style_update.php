...
class style_update extends \src\db\migration\migration
{
	static public function depends_on()
	{
		return array('\src\db\migration\data\v310\gold');
	}
	...
	public function update_installed_styles()
	{
		...
		if (empty($style_paths) && in_array('prosilver', $styles))
		{
			...
			$cfg = parse_cfg_file($this->src_root_path . 'styles/prosilver/style.cfg');
	...
	{
		$styles = array();
		$styles_path = $this->src_root_path . 'styles/';
