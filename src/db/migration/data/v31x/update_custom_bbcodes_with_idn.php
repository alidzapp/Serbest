...
class update_custom_bbcodes_with_idn extends \src\db\migration\migration
{
	static public function depends_on()
	{
		return array(
			'\src\db\migration\data\v31x\v312',
		);
	}
	...
	public function update_bbcodes_table()
	{
		...
		{
			include($this->src_root_path . 'includes/acp/acp_bbcodes.' . $this->php_ext);
		}
