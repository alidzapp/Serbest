...
class release_3_0_1_rc1 extends \src\db\migration\migration
{
	public function effectively_installed()
	{
		return src_version_compare($this->config['version'], '3.0.1-RC1', '>=');
	}
	...
	public function reset_smiley_size()
	{
		...
		{
			if (file_exists($this->src_root_path . 'images/smilies/' . $smiley))
			{
				list($width, $height) = getimagesize($this->src_root_path . 'images/smilies/' . $smiley);
