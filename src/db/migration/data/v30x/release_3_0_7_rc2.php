...
class release_3_0_7_rc2 extends \src\db\migration\migration
{
	public function effectively_installed()
	{
		return src_version_compare($this->config['version'], '3.0.7-RC2', '>=');
	}

	static public function depends_on()
	{
		return array('\src\db\migration\data\v30x\release_3_0_7_rc1');
	}
	...
	public function update_email_hash($start = 0)
	{
		...
		while ($row = $this->db->sql_fetchrow($result))
		{
			...
			// Snapshot of the src_email_hash() function
