...
class profilefield_twitter extends \src\db\migration\profilefield_base_migration
{
	...
	protected $profilefield_name = 'src_twitter';

	protected $profilefield_database_type = array('VCHAR', '');

	protected $profilefield_data = array(
		'field_name'			=> 'src_twitter',
		'field_type'			=> 'profilefields.type.string',
		'field_ident'			=> 'src_twitter',
		'field_length'			=> '20',
		'field_minlen'			=> '1',
		'field_maxlen'			=> '15',
		'field_novalue'			=> '',
