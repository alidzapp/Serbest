...
class profilefield_youtube extends \src\db\migration\profilefield_base_migration
{
	...
	protected $profilefield_name = 'src_youtube';

	protected $profilefield_database_type = array('VCHAR', '');

	protected $profilefield_data = array(
		'field_name'			=> 'src_youtube',
		'field_type'			=> 'profilefields.type.string',
		'field_ident'			=> 'src_youtube',
		'field_length'			=> '20',
		'field_minlen'			=> '3',
		'field_maxlen'			=> '60',
		'field_novalue'			=> '',
