...
class auth_provider_oauth extends \src\db\migration\migration
{
		...
		return array(
			'add_tables'	=> array(
				$this->table_prefix . 'oauth_tokens'	=> array(
					'COLUMNS' => array(
						'user_id'			=> array('UINT', 0), // src_users.user_id
						'session_id'		=> array('CHAR:32', ''), // src_sessions.session_id used only when user_id not set
