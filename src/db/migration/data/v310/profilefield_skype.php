...
class profilefield_skype extends \src\db\migration\profilefield_base_migration
{
	...
	protected $profilefield_name = 'src_skype';

	protected $profilefield_database_type = array('VCHAR', '');

	protected $profilefield_data = array(
		'field_name'			=> 'src_skype',
		'field_type'			=> 'profilefields.type.string',
		'field_ident'			=> 'src_skype',
		'field_length'			=> '20',
		'field_minlen'			=> '6',
		'field_maxlen'			=> '32',
		'field_novalue'			=> '',
