...
class profilefield_facebook extends \src\db\migration\profilefield_base_migration
{
	...
	protected $profilefield_name = 'src_facebook';

	protected $profilefield_database_type = array('VCHAR', '');

	protected $profilefield_data = array(
		'field_name'			=> 'src_facebook',
		'field_type'			=> 'profilefields.type.string',
		'field_ident'			=> 'src_facebook',
		'field_length'			=> '20',
		'field_minlen'			=> '5',
		'field_maxlen'			=> '50',
		'field_novalue'			=> '',
