...
abstract class migration
{
	...
	* @param \src\db\tools $db_tools
	* @param string $src_root_path
	* @param string $php_ext
	* @param string $table_prefix
	*/
	public function __construct(\src\config\config $config, \src\db\driver\driver_interface $db, \src\db\tools $db_tools, $src_root_path, $php_ext, $table_prefix)
	{
		$this->config = $config;
		$this->db = $db;
