...
class mssqlnative extends \src\db\driver\mssql_base
{
	...
	*/
	function sql_connect($sqlserver, $sqluser, $sqlpassword, $database, $port = false, $persistency = false, $new_link = false)
	{
		...
		{
			$this->connect_error = 'Native MS SQL Server driver for PHP is missing or needs to be updated. Version 1.1 or later is required to install src3. You can download the driver from: http://www.microsoft.com/sqlserver/2005/en/us/PHP-Driver.aspx';
	...
	*/
	function sql_query($query = '', $cache_ttl = 0)
	{
		if ($query != '')
		{
			...
			else if (defined('src_DISPLAY_LOAD_TIME'))
			{
