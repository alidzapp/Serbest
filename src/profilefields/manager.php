...
class manager
{
	...
	* @param	\src\event\dispatcher_interface		$dispatcher	Event dispatcher object
	* @param	\src\request\request		$request	Request object
	* @param	\src\template\template	$template	Template object
	* @param	\src\di\service_collection $type_collection
	* @param	\src\user					$user		User object
	* @param	string				$fields_table
	* @param	string				$fields_language_table
	* @param	string				$fields_data_table
	*/
	public function __construct(\src\auth\auth $auth, \src\db\driver\driver_interface $db, \src\event\dispatcher_interface $dispatcher, \src\request\request $request, \src\template\template $template, \src\di\service_collection $type_collection, \src\user $user, $fields_table, $fields_language_table, $fields_data_table)
	{
		$this->auth = $auth;
		$this->db = $db;
