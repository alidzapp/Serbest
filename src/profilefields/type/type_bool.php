...
class type_bool extends type_base
{
	...
	* @var \src\profilefields\lang_helper
	*/
	...
	* Construct
	*
	* @param	\src\profilefields\lang_helper		$lang_helper	Profile fields language helper
	...
	*/
	public function __construct(\src\profilefields\lang_helper $lang_helper, \src\request\request $request, \src\template\template $template, \src\user $user)
	{
