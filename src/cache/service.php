...
class service
{
	...
	*
	* @param \src\cache\driver\driver_interface $driver The cache driver
	...
	*/
	public function __construct(\src\cache\driver\driver_interface $driver, \src\config\config $config, \src\db\driver\driver_interface $db, $src_root_path, $php_ext)
	{
	...
	*
	* @return \src\cache\driver\driver_interface The cache driver
	*/
	...
	* @param \src\cache\driver\driver_interface $driver The cache driver
	*/
	public function set_driver(\src\cache\driver\driver_interface $driver)
	{
		$this->driver = $driver;
	}
	...
	*/
	function obtain_cfg_items($style)
	{
		...
		$filename = $this->src_root_path . 'styles/' . $style['style_path'] . '/style.cfg';
