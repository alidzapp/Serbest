...
class user_loader
{
	...
	* @param string $users_table The name of the database table (src_users)
	*/
	public function __construct(\src\db\driver\driver_interface $db, $src_root_path, $php_ext, $users_table)
	{
		$this->db = $db;
