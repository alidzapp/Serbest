...
class qa
{
	...
	*/
	function init($type)
	{
		...
		// fallback to the srcrd default lang
	...
	*/
	public function is_installed()
	{
		...
		$db_tool = new \src\db\tools($db);

		return $db_tool->sql_table_exists($this->table_captcha_questions);
	}

	/**
	*  API function - for the captcha to be available, it must have installed itself and there has to be at least one question in the srcrd's default lang
	*/
