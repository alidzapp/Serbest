...
*/
class prune_shadow_topics extends \src\cron\task\base implements \src\cron\task\parametrized
{
	...
	* @param \src\log\log $log The src log system
	* @param \src\user $user The src user object
	*/
	public function __construct($src_root_path, $php_ext, \src\config\config $config, \src\db\driver\driver_interface $db, \src\log\log $log, \src\user $user)
	{
