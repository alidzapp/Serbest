...
*/
class tidy_plupload extends \src\cron\task\base
{
	/**
	...
	*/
	public function __construct($src_root_path, \src\config\config $config)
	{
		$this->src_root_path = $src_root_path;
		$this->config = $config;

		$this->plupload_upload_path = $this->src_root_path . $this->config['upload_path'] . '/plupload';
	}
