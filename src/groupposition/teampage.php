...
class teampage implements \src\groupposition\groupposition_interface
{
	/**
	...
	*/
	public function __construct(\src\db\driver\driver_interface $db, \src\user $user, \src\cache\driver\driver_interface $cache)
	{
		$this->db = $db;
		$this->user = $user;
		$this->cache = $cache;
	...
	* @throws \src\groupposition\exception
	*/
	public function get_group_value($group_id)
	{
		...
		{
			// Group not found.
			throw new \src\groupposition\exception('NO_GROUP');
		}
