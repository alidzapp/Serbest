...
interface provider_interface
{
	 ...
	 * provider.
	 * Called in acp_srcrd while setting authentication plugins.
	 * Changing to an authentication provider will not be permitted in acp_srcrd
	...
	* a forum account.
	*
	* @param	array	$login_link_data	Any data needed to link a src account to
	*								an external account.
	...
	*/
	...
	/**
	* Links an external account to a src account.
	*
	* @param	array	$link_data	Any data needed to link a src account to
	*								an external account.
	*/
	...
	*/
	...
	/**
	* Unlinks an external account from a src account.
	*
	* @param	array	$link_data	Any data needed to unlink a src account
	*								from a src account.
	*/
