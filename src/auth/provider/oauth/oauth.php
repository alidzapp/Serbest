...
namespace src\auth\provider\oauth;

use OAuth\Common\Consumer\Credentials;

/**
* OAuth authentication provider for src3
*/
class oauth extends \src\auth\provider\base
{
	/**
	* Database driver
	*
	...
	*/
	...
	/**
	* src passwords manager
	*
	* @var \src\passwords\manager
	*/
	...
	*
	* @var \src\di\service_collection Contains \src\auth\provider\oauth\service_interface
	*/
	...
	* @param	\src\passwords\manager	$passwords_manager
	...
	* @param	\src\di\service_collection	$service_providers Contains \src\auth\provider\oauth\service_interface
	* @param	string			$users_table
	* @param	\Symfony\Component\DependencyInjection\ContainerInterface $src_container DI container
	* @param	string			$src_root_path
	* @param	string			$php_ext
	*/
	public function __construct(\src\db\driver\driver_interface $db, \src\config\config $config, \src\passwords\manager $passwords_manager, \src\request\request_interface $request, \src\user $user, $auth_provider_oauth_token_storage_table, $auth_provider_oauth_token_account_assoc, \src\di\service_collection $service_providers, $users_table, \Symfony\Component\DependencyInjection\ContainerInterface $src_container, $src_root_path, $php_ext)
	{
		$this->db = $db;
		$this->config = $config;
	...
	*
	* @param	string	$service_name			The name of the service
	* @param	\src\auth\provider\oauth\token_storage $storage
	* @param	array	$service_credentials	{@see \src\auth\provider\oauth\oauth::get_service_credentials}
	...
	* @throws	\Exception
	*/
	protected function get_service($service_name, \src\auth\provider\oauth\token_storage $storage, array $service_credentials, $query, array $scopes = array())
	{
