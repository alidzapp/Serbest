...
/**
 * Database authentication provider for src3
 * This is for authentication via the integrated user table
 */
class db extends \src\auth\provider\base
{
	/**
	...
	*/
	 ...
	 * @param	\src\request\request		$request
	 * @param	\src\user			$user
	 * @param	\Symfony\Component\DependencyInjection\ContainerInterface $src_container DI container
	 * @param	string				$src_root_path
	 * @param	string				$php_ext
	 */
	public function __construct(\src\db\driver\driver_interface $db, \src\config\config $config, \src\passwords\manager $passwords_manager, \src\request\request $request, \src\user $user, \Symfony\Component\DependencyInjection\ContainerInterface $src_container, $src_root_path, $php_ext)
	{
		$this->db = $db;
		$this->config = $config;
