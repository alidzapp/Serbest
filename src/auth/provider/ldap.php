 ...
 */
class ldap extends \src\auth\provider\base
{
	/**
	...
	*/
	 ...
	 */
	public function __construct(\src\db\driver\driver_interface $db, \src\config\config $config, \src\passwords\manager $passwords_manager, \src\user $user)
	{
		$this->db = $db;
		$this->config = $config;
