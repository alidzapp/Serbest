...
class deactivated_super_global implements \ArrayAccess, \Countable, \IteratorAggregate
{
	...
	*/
	...
	/**
	* @var	\src\request\request_interface::POST|GET|REQUEST|COOKIE	Super global constant.
	*/
	private $super_global;

	/**
	* @var	\src\request\request_interface	The request class instance holding the actual request data.
	*/
	private $request;
	...
	*
	* @param	\src\request\request_interface	$request	A request class instance holding the real super global data.
	* @param	string					$name		Name of the super global this is a replacement for - e.g. '_GET'.
	* @param	\src\request\request_interface::POST|GET|REQUEST|COOKIE	$super_global	The variable's super global constant.
	*/
	public function __construct(\src\request\request_interface $request, $name, $super_global)
	{
