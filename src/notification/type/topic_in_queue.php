...
class topic_in_queue extends \src\notification\type\topic
{
	/**
	...
	*/
	...
	{
		return append_sid($this->src_root_path . 'mcp.' . $this->php_ext, "i=queue&amp;mode=approve_details&amp;f={$this->item_parent_id}&amp;t={$this->item_id}");
	}
