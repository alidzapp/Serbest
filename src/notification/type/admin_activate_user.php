...
class admin_activate_user extends \src\notification\type\base
{
	/**
	* {@inheritdoc}
	*/
	...
	*/
	public function get_email_template_variables()
	{
		...
		return array(
			...
			'U_USER_DETAILS'	=> "{$srcrd_url}/memberlist.{$this->php_ext}?mode=viewprofile&u={$this->item_id}",
			'U_ACTIVATE'		=> "{$srcrd_url}/ucp.{$this->php_ext}?mode=activate&u={$this->item_id}&k={$this->get_data('user_actkey')}",
		);
	}
