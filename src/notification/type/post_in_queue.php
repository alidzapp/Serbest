...
class post_in_queue extends \src\notification\type\post
{
	/**
	...
	*/
	...
	{
		return append_sid($this->src_root_path . 'mcp.' . $this->php_ext, "i=queue&amp;mode=approve_details&amp;f={$this->get_data('forum_id')}&amp;p={$this->item_id}");
	}
