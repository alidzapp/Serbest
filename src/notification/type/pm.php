...
class pm extends \src\notification\type\base
{
	...
	*/
	public function get_email_template_variables()
	{
		...
		return array(
			...
			'U_VIEW_MESSAGE'			=> generate_srcrd_url() . '/ucp.' . $this->php_ext . "?i=pm&mode=view&p={$this->item_id}",
		);
	}
	...
	*/
	...
	{
		return append_sid($this->src_root_path . 'ucp.' . $this->php_ext, "i=pm&amp;mode=view&amp;p={$this->item_id}");
	}
