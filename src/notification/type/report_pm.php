...
class report_pm extends \src\notification\type\pm
{
	...
	*/
	public function get_email_template_variables()
	{
		return array(
			...
			'U_VIEW_REPORT'				=> generate_srcrd_url() . "mcp.{$this->php_ext}?r={$this->item_parent_id}&amp;i=pm_reports&amp;mode=pm_report_details",
		);
	}
	...
	*/
	...
	{
		return append_sid($this->src_root_path . 'mcp.' . $this->php_ext, "r={$this->item_parent_id}&amp;i=pm_reports&amp;mode=pm_report_details");
	}
