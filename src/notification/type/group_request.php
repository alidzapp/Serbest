...
class group_request extends \src\notification\type\base
{
	/**
	* {@inheritdoc}
	*/
	...
	*/
	public function get_email_template_variables()
	{
		...
		return array(
			...
			'U_PENDING'			  		=> generate_srcrd_url() . "/ucp.{$this->php_ext}?i=groups&mode=manage&action=list&g={$this->item_parent_id}",
			'U_GROUP'					=> generate_srcrd_url() . "/memberlist.{$this->php_ext}?mode=group&g={$this->item_parent_id}",
		);
	}
	...
	*/
	...
	{
		return append_sid($this->src_root_path . 'ucp.' . $this->php_ext, "i=groups&mode=manage&action=list&g={$this->item_parent_id}");
	}
