...
abstract class base implements \src\notification\type\type_interface
{
	...
	*/
	public function __construct(\src\user_loader $user_loader, \src\db\driver\driver_interface $db, \src\cache\driver\driver_interface $cache, $user, \src\auth\auth $auth, \src\config\config $config, $src_root_path, $php_ext, $notification_types_table, $notifications_table, $user_notifications_table)
	{
