...
class manager
{
	...
	* @param ContainerInterface $src_container
	* @param \src\user_loader $user_loader
	* @param \src\config\config $config
	* @param \src\event\dispatcher_interface $src_dispatcher
	...
	* @return \src\notification\manager
	*/
	public function __construct($notification_types, $notification_methods, ContainerInterface $src_container, \src\user_loader $user_loader, \src\config\config $config, \src\event\dispatcher_interface $src_dispatcher, \src\db\driver\driver_interface $db, \src\cache\service $cache, $user, $src_root_path, $php_ext, $notification_types_table, $notifications_table, $user_notifications_table)
	{
	...
	*/
	...
	{
		$object = $this->src_container->get($object_name);
