...
namespace design\designTCP\event;
...
class main_listener implements EventSubscriberInterface
{
   ...
   * Constructor
   *
   * @param \src\config\config      $this->config    Config object
   * @param \src\controller\helper  $helper    Helper object
   * @param \src\template\template  $template  Template object
   * @param \src\user               $user      User object
   */
  public function __construct(\src\config\config $config, \src\template\template $template, \src\user $user, \src\controller\helper $helper)
  {
    $this->config = $config;
