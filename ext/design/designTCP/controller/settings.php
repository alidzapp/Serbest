...
class settings
{
   ...
   */
  public function __construct(\src\auth\auth $auth, \src\config\config $config, \src\request\request $request, \src\user $user, \src\controller\helper $helper)
  {
    $this->auth = $auth;
    $this->config = $config;
