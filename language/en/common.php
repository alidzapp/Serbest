...
$lang = array_merge($lang, array(
	...
	// See http://wiki.src.com/Plural_Rules for more information
	...
	'ACP_SHORT'						=> 'ACP',
	'ACTIVE'						=> 'active',
	'ACTIVE_ERROR'					=> 'The specified username is currently inactive. If you have problems activating your account, please contact a administrator.',
	...
	'BCC'					=> 'BCC',
	'BIRTHDAYS'				=> 'Birthdays',
	'srcRD_BAN_PERM'		=> 'You have been <strong>permanently</strong> banned.<br /><br />Please contact the %2$Administrator%3$s for more information.',
	'srcRD_BAN_REASON'		=> 'Reason given for ban: <strong>%s</strong>',
	'srcRD_BAN_TIME'		=> 'You have been banned until <strong>%1$s</strong>.<br /><br />Please contact the %2$sAdministrator%3$s for more information.',
	'srcRD_DISABLE'			=> 'Sorry but this is currently unavailable.',
	'srcRD_DISABLED'		=> 'This is currently disabled.',
	'srcRD_UNAVAILABLE'		=> 'Sorry but this is temporarily unavailable, please try again in a few minutes.',
	...
	'CHANGING_PREFERENCES'	=> 'Changing preferences',
	...
	'COOKIES_DELETED'		=> 'All cookies successfully deleted.',
	...
	'ERR_WRONG_PATH_TO_src'			=> 'The src path specified appears to be invalid.',
	'ERROR'									=> 'Error',
	...
	'FTP_FSOCK_ROOT_PATH'			=> 'Path to src',
	'FTP_FSOCK_ROOT_PATH_EXPLAIN'	=> 'Path from the root to your server.',
	...
	'FTP_ROOT_PATH'				=> 'Path to src',
	'FTP_ROOT_PATH_EXPLAIN'		=> 'Path from the root to your server.',
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> 'To prevent brute forcing accounts this software requires you to enter a confirmation code after a maximum amount of failed logins. The code is displayed in the image you should see below. If you are visually impaired or cannot otherwise read this code please contact the %Administrator%s.', // unused
	...
	'LOGIN_ERROR_PASSWORD'				=> 'You have specified an incorrect password. Please check your password and try again. If you continue to have problems please contact the %Administrator%s.',
	'LOGIN_ERROR_PASSWORD_CONVERT'		=> 'It was not possible to convert your password when updating this bulletin software. Please %srequest a new password%s. If you continue to have problems please contact the % Administrator%s.',
	'LOGIN_ERROR_USERNAME'				=> 'You have specified an incorrect username. Please check your username and try again. If you continue to have problems please contact the %Administrator%s.',
	'LOGIN_FORUM'						=> 'To view or post in this forum you must enter its password.',
	'LOGIN_INFO'						=> '',
	'LOGIN_VIEWFORUM'					=> 'This website requires you to be registered and logged in to view this site.',
	...
	'NOTIFY_ADMIN'				=> 'Please notify the administrator or webmaster.',
	'NOTIFY_ADMIN_EMAIL'		=> 'Please notify the administrator or webmaster: <a href="mailto:%1$s">%1$s</a>',
	...
	'NO_FORUMS'					=> 'This site has no forums.',
	...
	'NO_FEED_ENABLED'			=> 'Feeds are not available.',
	...
	'REMOVE'					=> 'Remove',
	'REMOVE_INSTALL'			=> 'Please delete, move or rename the install directory before you use your software. If this directory is still present, only the Administration Control Panel (ACP) will be accessible.',
	'REPLIES'					=> 'Replies',
	...
	'RETURN_TO_INDEX'			=> 'Return to Front End',
	'FEED'						=> 'Feed',
	'FEED_NEWS'					=> 'News',
	...
	'SQL_ERROR_OCCURRED'		=> 'An SQL error occurred while fetching this page. Please contact the %s Administrator%s if this problem persists.',
	...
	'timezones'		=> array(
		...
		'America/src_Vista'		=> 'America/src Vista',
