...
$lang = array_merge($lang, array(
	...
	'ACP_BBCODES'				=> 'BBCodes',
	'ACP_srcRD_CONFIGURATION'	=> 'Site configuration',
	'ACP_srcRD_FEATURES'		=> 'Site features',
	'ACP_srcRD_MANAGEMENT'		=> 'Site management',
	'ACP_srcRD_SETTINGS'		=> 'Site settings',
	...
	'ACP_SEND_STATISTICS'		=> 'Block Server',
	...
	'ACP_VERSION_CHECK'					=> 'Current Status',
	...
	'LOGIN_ADMIN'			=> 'To administer the site you must be an authenticated user.',
	'LOGIN_ADMIN_CONFIRM'	=> 'To administer the site you must re-authenticate yourself.',
	...
	'NOTIFY'				=> 'Notification',
	'NO_ADMIN'				=> 'You are not authorised to administer this site.',
	...
	'PERMISSIONS_TRANSFERRED_EXPLAIN'	=> 'You currently have the permissions from %1$s. You are able to browse with this user’s permissions, but not access the administration control panel since admin permissions were not transferred. You can <a href="%2$s"><strong>revert to your permission set</strong></a> at any time.',
...
// PHP info
$lang = array_merge($lang, array(
	'ACP_PHP_INFO_EXPLAIN'	=> 'This page lists information on the version of PHP installed on this server. It includes details of loaded modules, available variables and default settings. This information may be useful when diagnosing problems. Please be aware that some hosting companies will limit what information is displayed here for security reasons. You are advised to not give out any details on this page except when asked by <a href="https://www.src.com/about/team/">official team members</a> on the support forums.',
...
// Logs
$lang = array_merge($lang, array(
	'ACP_ADMIN_LOGS_EXPLAIN'	=> 'This lists all the actions carried out by administrators. You can sort by username, date, IP or action. If you have appropriate permissions you can also clear individual operations or the log as a whole.',
	'ACP_CRITICAL_LOGS_EXPLAIN'	=> 'This lists the actions carried out by the site itself. This log provides you with information you are able to use for solving specific problems, for example non-delivery of emails. You can sort by username, date, IP or action. If you have appropriate permissions you can also clear individual operations or the log as a whole.',
...
// Index page
$lang = array_merge($lang, array(
	'ADMIN_INTRO'				=> 'This screen will give you a quick overview of all the various statistics of your site. The links on the left hand side of this screen allow you to control every aspect of your site experience.',
	'ADMIN_LOG'					=> 'Logged administrator actions',
	'ADMIN_LOG_INDEX_EXPLAIN'	=> 'This gives an overview of the last five actions carried out by site administrators. A full copy of the log can be viewed from the appropriate menu item or following the link below.',
	'AVATAR_DIR_SIZE'			=> 'Avatar directory size',

	'srcRD_STARTED'		=> 'Site started',
	'srcRD_VERSION'		=> 'Cron status',
	...
	'PHP_VERSION_OLD'	=> 'The version of PHP on this server will no longer be supported by future versions of src. %sDetails%s',
	...
	'RESET_DATE'					=> 'Reset start date',
	'RESET_DATE_CONFIRM'			=> 'Are you sure you wish to reset the start date?',
	'RESET_DATE_SUCCESS'				=> 'Start date reset',
	...
	'WELCOME_src'			=> 'Serbest Dashboard',
	'WRITABLE_CONFIG'		=> 'Your config file (config.php) is currently world-writable. We advise you to change the permissions to 640 or at least to 644.',
));
...
$lang = array_merge($lang, array(
	'EXPLAIN_SEND_STATISTICS'	=> 'All information of your website will be removed.',
	'EXPLAIN_SHOW_STATISTICS'	=> 'Using the button below you can preview all variables.',
	'DONT_SEND_STATISTICS'		=> 'Return to the ACP.',
	'GO_ACP_MAIN'				=> 'Go to the ACP start page',
	'HIDE_STATISTICS'			=> 'Hide details',
	'SEND_STATISTICS'			=> 'Block Server',
...
$lang = array_merge($lang, array(
	...
	'LOG_CONFIG_FEATURES'		=> '<strong>Altered features</strong>',
	...
	'LOG_CONFIG_SETTINGS'		=> '<strong>Altered settings</strong>',
	...
	'LOG_INSTALL_CONVERTED'	=> '<strong>Converted from %1$s to src %2$s</strong>',
	'LOG_INSTALL_INSTALLED'	=> '<strong>Installed src</strong>',
	...
	'LOG_RESET_DATE'			=> '<strong>Start date reset</strong>',
	...
	'LOG_UPDATE_src'		=> '<strong>Updated from version %1$s to version %2$s</strong>',
