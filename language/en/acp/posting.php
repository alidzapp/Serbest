...
$lang = array_merge($lang, array(
	...
	'tokens'	=>	array(
		...
		'RELATIVE_URL'	=> 'A relative URL. You can use this to match parts of a URL, but be careful: a full URL is a valid relative URL. When you want to use relative URLs of your site, use the LOCAL_URL token.',
...
$lang = array_merge($lang, array(
	...
	'RANK_IMAGE_EXPLAIN'	=> 'Use this to define a small image associated with the rank. The path is relative to the root src directory.',
