...
$lang = array_merge($lang, array(
	...
	'FULLTEXT_SPHINX_WRONG_DATABASE'		=> 'The sphinx search for src supports MySQL and PostgreSQL only.',
	...
	'INDEXING_IN_PROGRESS_EXPLAIN'			=> 'The search backend is currently indexing all posts on the site. This can take from a few minutes to a few hours depending on your site’s size.',
	...
	'SEARCH_INDEX_CREATED'					=> 'Successfully indexed all posts in the site database.',
	...
	'SEARCH_TYPE_EXPLAIN'					=> 'src allows you to choose the backend that is used for searching text in post contents. By default the search will use src’s own fulltext search.',
