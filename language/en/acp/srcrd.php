...
$lang = array_merge($lang, array(
	'ACP_srcRD_SETTINGS_EXPLAIN'	=> 'Here you can determine the basic operation of your site, give it a fitting name and description, and among other settings adjust the default values for timezone and language.',
	'srcRD_INDEX_TEXT'				=> 'Front End text',
	'srcRD_INDEX_TEXT_EXPLAIN'		=> 'This text is displayed as the Front End in the site breadcrumbs. If not specified, it will default to “Front End index”.',
	'srcRD_STYLE'					=> 'Site style',
	...
	'DISABLE_srcRD'					=> 'Disable site',
	'DISABLE_srcRD_EXPLAIN'			=> 'This will make the site unavailable to users who are neither administrators nor moderators. You can also enter a short (255 character) message to display if you wish.',
	...
	'GUEST_STYLE_EXPLAIN'			=> 'The style for guests.',
	...
	'SITE_HOME_TEXT_EXPLAIN'		=> 'This text will be displayed as a link to your website homepage in the site breadcrumbs. If not specified, it will default to “Home”.',
	'SITE_HOME_URL'					=> 'Main website URL',
	'SITE_HOME_URL_EXPLAIN'			=> 'If specified, a link to this URL will be prepended to your site breadcrumbs and the srcrd logo will link to this URL instead of the forum index.',
	'SITE_NAME'						=> 'Site name',
...
// srcrd Features
$lang = array_merge($lang, array(
	'ACP_srcRD_FEATURES_EXPLAIN'	=> 'Here you can enable/disable several features.',

	'ALLOW_ATTACHMENTS'			=> 'Allow attachments',
	'ALLOW_BIRTHDAYS'			=> 'Allow birthdays',
	'ALLOW_BIRTHDAYS_EXPLAIN'	=> 'Allow birthdays to be entered and age being displayed in profiles. Please note the birthday list within the Front End is controlled by a separate load setting.',
	...
	'ALLOW_PM_REPORT_EXPLAIN'	=> 'If this setting is enabled, users have the option of reporting a private message they have received or sent to the moderators. These private messages will then be visible in the Moderator Control Panel.',
	'ALLOW_QUICK_REPLY'			=> 'Allow quick reply',
	'ALLOW_QUICK_REPLY_EXPLAIN'	=> 'This switch allows for the quick reply to be disabled site-wide. When enabled, forum specific settings will be used to determine whether the quick reply is displayed in individual forums.',
	...
	'srcRD_PM'					=> 'Private messaging',
	'srcRD_PM_EXPLAIN'			=> 'Enable private messaging for all users.',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_AVATARS_EXPLAIN'			=> 'Allow general usage of avatars;<br />If you disable avatars in general or avatars of a certain mode, the disabled avatars will no longer be shown on the site, but users will still be able to download their own avatars in the User Control Panel.',
	...
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> 'Path under your root directory for pre-loaded images, e.g. <samp>images/avatars/gallery</samp>.<br />Double dots like <samp>../</samp> will be stripped from the path for security reasons.',
	'AVATAR_STORAGE_PATH'			=> 'Avatar storage path',
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Path under your root directory, e.g. <samp>images/avatars/upload</samp>.<br />Avatar uploading <strong>will not be available</strong> if this path is not writable.<br />Double dots like <samp>../</samp> will be stripped from the path for security reasons.',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_EXPLAIN'		=> 'This determines whether users have immediate access to the site or if confirmation is required. You can also completely disable new registrations. <em>“site-wide email” must be enabled in order to use user or admin activation.</em>',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_ENABLE_EXPLAIN'			=> 'Turns on or off ATOM feeds for the entire site.<br />Disabling this switches off all feeds, no matter how the options below are set.',
	'ACP_FEED_LIMIT'					=> 'Number of items',
	'ACP_FEED_LIMIT_EXPLAIN'			=> 'The maximum number of feed items to display.',

	'ACP_FEED_OVERALL'					=> 'Enable site-wide feed',
	'ACP_FEED_OVERALL_EXPLAIN'			=> 'Site-wide new posts.',
...
$lang = array_merge($lang, array(
	...
	'CAPTCHA_SELECT_EXPLAIN'				=> 'The dropdown holds the plugins recognised by the site. Grey entries are not available right now and might need configuration prior to use.',
...
$lang = array_merge($lang, array(
	...
	'CONTACT_US_ENABLE_EXPLAIN'		=> 'This page allows users to send emails to administrators',
...
// Load Settings
$lang = array_merge($lang, array(
	'ACP_LOAD_SETTINGS_EXPLAIN'	=> 'Here you can enable and disable certain functions to reduce the amount of processing required. On most servers there is no need to disable any functions. However on certain systems or in shared hosting environments it may be beneficial to disable capabilities you do not really need. You can also specify limits for system load and active sessions beyond which the site will go offline.',

	'ALLOW_CDN'						=> 'Allow usage of third party content delivery networks',
	'ALLOW_CDN_EXPLAIN'				=> 'If this setting is enabled, some files will be served from external third party servers instead of your server. This reduces the network bandwidth required by your server, but may present a privacy issue for some administrators. In this installation, this includes loading “jQuery” and the font “Open Sans” from Google’s content delivery network.',
	'ALLOW_LIVE_SEARCHES'			=> 'Allow live searches',
	'ALLOW_LIVE_SEARCHES_EXPLAIN'	=> 'If this setting is enabled, users are provided with keyword suggestions as they type in certain fields throughout the site.',
	'CUSTOM_PROFILE_FIELDS'			=> 'Custom profile fields',
	'LIMIT_LOAD'					=> 'Limit system load',
	'LIMIT_LOAD_EXPLAIN'			=> 'If the system’s 1-minute load average exceeds this value the site will automatically go offline. A value of 1.0 equals ~100% utilisation of one processor. This only functions on UNIX based servers and where this information is accessible. The value here resets itself to 0 if it was unable to get the load limit.',
	'LIMIT_SESSIONS'				=> 'Limit sessions',
	'LIMIT_SESSIONS_EXPLAIN'		=> 'If the number of sessions exceeds this value within a one minute period the site will go offline. Set to 0 for unlimited sessions.',
	...
	'LOAD_USER_ACTIVITY_EXPLAIN'	=> 'Displays active topic/forum in user profiles and user control panel. It is recommended to disable this on site with more than one million posts.',
...
// Auth settings
$lang = array_merge($lang, array(
	'ACP_AUTH_SETTINGS_EXPLAIN'	=> 'Supports authentication plug-ins, or modules. These allow you determine how users are authenticated when they log into the site. By default four plug-ins are provided: DB, LDAP, Apache, and OAuth. Not all methods require additional information so only fill out fields if they are relevant to the selected method.',
	...
	'APACHE_SETUP_BEFORE_USE'	=> 'You have to setup apache authentication before you switch src to this authentication method. Keep in mind that the username you use for apache authentication has to be the same as your src username. Apache authentication can only be used with mod_php (not with a CGI version) and safe_mode disabled.',
	...
	'LDAP_USER_EXPLAIN'				=> 'Leave blank to use anonymous binding. If filled in src uses the specified distinguished name on login attempts to find the correct user, e.g. <samp>uid=Username,ou=MyUnit,o=MyCompany,c=US</samp>. Required for Active Directory Servers.',
...
$lang = array_merge($lang, array(
	...
	'ICONS_PATH_EXPLAIN'		=> 'Path under your root directory, e.g. <samp>images/icons</samp>.',
	'MOD_REWRITE_ENABLE'		=> 'Enable URL Rewriting',
	'MOD_REWRITE_ENABLE_EXPLAIN' => 'When enabled, URLs containing ’app.php’ will be rewritten to remove the filename (i.e. app.php/foo will become /foo). <strong>Apache server’s mod_rewrite module is required for this functionality to work; if this option is enabled without mod_rewrite support, URLs on your site may be broken.</strong>',
	...
	'MOD_REWRITE_INFORMATION_UNAVAILABLE' => 'We are unable to determine whether or not this server supports URL rewriting. This setting may be enabled but if URL rewriting is not available, paths generated by this site (such as for use in links) may be broken. Contact your web hosting provider if you are unsure whether or not you can safely enable this feature.',
	'PATH_SETTINGS'				=> 'Path settings',
	'RANKS_PATH'				=> 'Rank image storage path',
	'RANKS_PATH_EXPLAIN'		=> 'Path under your root directory, e.g. <samp>images/ranks</samp>.',
	'SCRIPT_PATH'				=> 'Script path',
	'SCRIPT_PATH_EXPLAIN'		=> 'The path where it is located relative to the domain name, e.g. <samp>/src</samp>.',
	'SERVER_NAME'				=> 'Domain name',
	'SERVER_NAME_EXPLAIN'		=> 'The domain name this site runs from (for example: <samp>www.example.com</samp>).',
	...
	'SMILIES_PATH_EXPLAIN'		=> 'Path under your root directory, e.g. <samp>images/smilies</samp>.',
	'UPLOAD_ICONS_PATH'			=> 'Extension group icons storage path',
	'UPLOAD_ICONS_PATH_EXPLAIN'	=> 'Path under your root directory, e.g. <samp>images/upload_icons</samp>.',
	'USE_SYSTEM_CRON'		=> 'Run periodic tasks from system cron',
	'USE_SYSTEM_CRON_EXPLAIN'		=> 'When off, it will arrange for periodic tasks to be run automatically. When on, it will not schedule any periodic tasks by itself.',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_AUTOLOGIN_EXPLAIN'		=> 'Determines whether users are given "Remember Me" option when they visit the site.',
	...
	'REFERRER_VALID_EXPLAIN'		=> 'If enabled, the referrer of POST requests will be checked against the host/script path settings. This may cause issues with site using several domains and or external logins.',
...
// Email Settings
$lang = array_merge($lang, array(
	'ACP_EMAIL_SETTINGS_EXPLAIN'	=> 'This information is used when the site sends emails to your users. Please ensure the email address you specify is valid, any bounced or undeliverable messages will likely be sent to that address. If your host does not provide a native (PHP based) email service you can instead send messages directly using SMTP. This requires the address of an appropriate server (ask your provider if necessary). If the server requires authentication (and only if it does) enter the necessary username, password and authentication method.',
	...
	'srcRD_EMAIL_FORM'				=> 'Users send email via site',
	'srcRD_EMAIL_FORM_EXPLAIN'		=> 'Instead of showing the users email address users are able to send emails via the site.',
	'srcRD_HIDE_EMAILS'				=> 'Hide email addresses',
	'srcRD_HIDE_EMAILS_EXPLAIN'		=> 'This function keeps email addresses completely private.',
...
// Jabber settings
$lang = array_merge($lang, array(
	'ACP_JABBER_SETTINGS_EXPLAIN'	=> 'Here you can enable and control the use of Jabber for instant messaging and site notifications. Jabber is an open source protocol and therefore available for use by anyone. Some Jabber servers include gateways or transports which allow you to contact users on other networks. Not all servers offer all transports and changes in protocols can prevent transports from operating.',
