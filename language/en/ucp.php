...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> 'By accessing “%1$s” (hereinafter “we”, “us”, “our”, “%1$s”, “%2$s”), you agree to be legally bound by the following terms. If you do not agree to be legally bound by all of the following terms then please do not access and/or use “%1$s”.
	<br />	',

	'PRIVACY_POLICY'		=> 'This policy explains in detail how “%1$s” along with its affiliated companies (hereinafter “we”, “us”, “our”, “%1$s”, “%2$s”) and use any information collected during any session of usage by you.<br />
	<br />	',
));
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_EMAIL_CHANGED'			=> 'Your account has been updated. However, this requires account reactivation on email changes. An activation key has been sent to the new email address you provided. Please check your email for further information.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> 'Your account has been updated. However, this requires account reactivation by the administrators on email changes. An email has been sent to them and you will be informed when your account has been reactivated.',
	'ACCOUNT_INACTIVE'				=> 'Your account has been created. However, this requires account activation, an activation key has been sent to the email address you provided. Please check your email for further information.',
	'ACCOUNT_INACTIVE_ADMIN'		=> 'Your account has been created. However, this requires account activation by the administrator group. An email has been sent to them and you will be informed when your account has been activated.',
	...
	'ATTACHMENTS_EXPLAIN'			=> 'This is a list of attachments you have made in posts.',
	...
	'srcRD_DATE_FORMAT'			=> 'My date format',
	'srcRD_DATE_FORMAT_EXPLAIN'	=> 'The syntax used is identical to the PHP <a href="http://www.php.net/date">date()</a> function.',
	'srcRD_LANGUAGE'			=> 'My language',
	'srcRD_STYLE'				=> 'My style',
	'srcRD_TIMEZONE'			=> 'My timezone',
	'BOOKMARKS'					=> 'Bookmarks',
	...
	'BOOKMARKS_DISABLED'		=> 'Bookmarks are disabled.',
	...
	'CONFIRM_EXPLAIN'			=> 'To prevent automated registrations, we require you to enter a confirmation code. The code is displayed in the image you should see below. If you are visually impaired or cannot otherwise read this code please contact the %ssrcrd Administrator%s.',
	...
	'DELETE_COOKIES_CONFIRM'	=> 'Are you sure you want to delete all cookies?',
	...
	'FORCE_PASSWORD_EXPLAIN'	=> 'Before you may continue browsing, you are required to change your password.',
	...
	'HIDE_ONLINE_EXPLAIN'		=> 'Changing this setting won’t become effective until your next visit.',
	...
	'LOGIN_LINK'					=> 'Link or register your account on an external service with your account',
	'LOGIN_LINK_EXPLAIN'			=> 'You have attempted to login with an external service that is not yet connected to an account. You must now either link this account to an existing account or create a new account.',
	...
	'LOGIN_LINK_NO_DATA_PROVIDED'	=> 'No data has been provided to this page to link an external account to a forum account. Please contact the administrator if you continue to experience problems.',
	'LOGIN_KEY'					=> 'Login Key',
	'LOGIN_TIME'				=> 'Login Time',
	'LOGIN_REDIRECT'			=> 'You have been successfully logged in.',
	'LOGOUT_FAILED'				=> 'You were not logged out, as the request did not match your session. Please contact the administrator if you continue to experience problems.',
	...
	'NOTIFY_METHOD_EXPLAIN'			=> 'Method for sending messages sent.',
	...
	'PERMISSIONS_TRANSFERRED'	=> 'Successfully transferred permissions from <strong>%s</strong>, you are now able to browse with this user’s permissions.<br />Please note that admin permissions were not transferred. You are able to revert to your permission set at any time.',
	'PM_DISABLED'				=> 'Private messaging has been disabled.',
	'PM_FROM'					=> 'From',
	...
	'PROFILE_AUTOLOGIN_KEYS'	=> 'The "Remember Me" login keys automatically log you in. If you logout, the remember me login key is deleted only on the computer you are using to logout. Here you can see remember login keys created on other computers you used to access this site.',
	...
	'UCP_AUTH_LINK_ASK'			=> 'You currently have no account associated with this external service. Click the button below to link your account to an account with this external service.',
	'UCP_AUTH_LINK_ID'			=> 'Unique identifier',
	'UCP_AUTH_LINK_LINK'		=> 'Link',
	'UCP_AUTH_LINK_MANAGE'		=> 'Manage external account associations',
	'UCP_AUTH_LINK_NOT_SUPPORTED'	=> 'Linking accounts to external services is not supported by this current authentication method.',
	...
	'UCP_NOTIFICATION_OPTIONS_EXPLAIN'	=> 'Here you can set your preferred notification methods for the srcrd.',
	...
	'UCP_PASSWORD_RESET_DISABLED'	=> 'The password reset functionality has been disabled. If you need help accessing your account, please contact the %Administrator%s',
	...
	'GROUPS_EXPLAIN'	=> 'Usergroups enable admins to better administer users. By default you will be placed in a specific group, this is your default group. This group defines how you may appear to other users, for example your username colouration, avatar, rank, etc. Depending on whether the administrator allows it you may be allowed to change your default group. You may also be placed in or allowed to join other groups. Some groups may give you additional permissions to view content or increase your capabilities in other areas.',
