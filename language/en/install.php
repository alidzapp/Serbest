...
$lang = array_merge($lang, array(
	...
	'srcRD_NOT_INSTALLED'			=> 'No installation found',
	'srcRD_NOT_INSTALLED_EXPLAIN'	=> 'The src Unified Convertor Framework requires a default installation of src3 to function, please <a href="%s">proceed by first installing src3</a>.',
	'BACKUP_NOTICE'					=> 'Please backup your site before updating in case any problems arise during the update process.',
	...
	'COLLIDING_USERNAMES_FOUND'	=> 'Colliding usernames were found on your old site. In order to complete the conversion please delete or rename these users so that there is only one user on your old site for each clean username.',
	...
	'CONFIG_src_EMPTY'		=> 'The src3 config variable for “%s” is empty.',
	'CONFIG_RETRY'				=> 'Retry',
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'You have now successfully converted your site. You can now login and <a href="../">access your site</a>. Please ensure that the settings were transferred correctly before enabling your site by deleting the install directory.',
	'CONVERT_INTRO'				=> 'Welcome to the src Unified Convertor Framework',
	'CONVERT_INTRO_BODY'		=> 'From here, you are able to import data from other (installed) srcrd systems. The list below shows all the conversion modules currently available. If there is no convertor shown in this list for the software you wish to convert from, please contact administrator.',
	...
	'CONV_ERROR_ATTACH_FTP_DIR'			=> 'FTP upload for attachments is enabled at the old site. Please disable the FTP upload option and make sure a valid upload directory is specified, then copy all attachment files to this new web accessible directory. Once you have done this, restart the convertor.',
	...
	'CONV_ERROR_GET_CONFIG'				=> 'Could not retrieve your site configuration.',
	...
	'CONV_ERROR_NO_FORUM_PATH'			=> 'The relative path to the source has not been specified.',
	...
	'CONV_OPTIONS_BODY'					=> 'This page collects the data required to access the source. Enter the database details of your former; the converter will not change anything in the database given below. The source should be disabled to allow a consistent conversion.',
	...
	'COULD_NOT_FIND_PATH'		=> 'Could not find path to your former. Please check your settings and try again.<br />» %s was specified as the source path.',
	...
	'DB_HOST_EXPLAIN'			=> 'DSN stands for Data Source Name',
	'DB_NAME'					=> 'Database name',
	'DB_PASSWORD'				=> 'Database password',
	'DB_PORT'					=> 'Database server port',
	'DB_PORT_EXPLAIN'			=> 'Leave this blank unless you know the server operates on a non-standard port.',
	'DB_UPDATE_NOT_SUPPORTED'	=> 'We are sorry, but this script does not support updating from versions of src prior to “%1$s”. The version you currently have installed is “%2$s”. Please update to a previous version before running this script. Assistance with this is available in the Support Forum on src.com.',
	'DB_USERNAME'				=> 'Database username',
	'DB_TEST'					=> 'Test connection',
	'DEFAULT_LANG'				=> 'Default language',
	'DEFAULT_PREFIX_IS'			=> 'The convertor was not able to find tables with the specified prefix. Please make sure you have entered the correct details for the site you are converting from. The default table prefix for %1$s is <strong>%2$s</strong>.',
	'DEV_NO_TEST_FILE'			=> 'No value has been specified for the test_file variable in the convertor. If you are a user of this convertor, you should not be seeing this error, please report this message to the convertor author. If you are a convertor author, you must specify the name of a file which exists in the source site to allow the path to it to be verified.',
	...
	'DL_CONFIG_EXPLAIN'			=> 'You may download the complete config.php to your own PC. You will then need to upload the file manually, replacing any existing config.php in your src 3.1 root directory. Please remember to upload the file in ASCII format (see your FTP application documentation if you are unsure how to achieve this). When you have uploaded the config.php please click “Done” to move to the next stage.',
	...
	'FILES_REQUIRED_EXPLAIN'	=> '<strong>Required</strong> - In order to function correctly it needs to be able to access or write to certain files or directories. If you see “Not Found” you need to create the relevant file or directory. If you see “Unwritable” you need to change the permissions on the file or directory to allow it to write to it.',
	'FILLING_TABLE'				=> 'Filling table <strong>%s</strong>',
	'FILLING_TABLES'			=> 'Filling tables',

	'FINAL_STEP'				=> 'Process final step',
	'FORUM_ADDRESS'				=> 'Site address',
	'FORUM_ADDRESS_EXPLAIN'		=> 'This is the URL of your former site, for example <samp>http://www.example.com/src2/</samp>. If an address is entered here and not left empty every instance of this address will be replaced by your new site address within messages, private messages and signatures.',
	'FORUM_PATH'				=> 'Site path',
	'FORUM_PATH_EXPLAIN'		=> 'This is the <strong>relative</strong> path on disk to your former site from the <strong>root of this src3 installation</strong>.',
	'FOUND'						=> 'Found',
	'FTP_CONFIG'				=> 'Transfer config by FTP',
	'FTP_CONFIG_EXPLAIN'		=> 'src has detected the presence of the FTP module on this server. You may attempt to install your config.php via this if you wish. You will need to supply the information listed below. Remember your username and password are those to your server! (ask your hosting provider for details if you are unsure what these are).',
	'FTP_PATH'					=> 'FTP path',
	'FTP_PATH_EXPLAIN'			=> 'This is the path from your root directory to that of src, e.g. <samp>htdocs/src3/</samp>.',
	'FTP_UPLOAD'				=> 'Upload',

	'GPL'						=> 'General Public License',

	'INITIAL_CONFIG'			=> 'Basic configuration',
	'INITIAL_CONFIG_EXPLAIN'	=> 'Now that install has determined your server can run src you need to supply some specific information. If you do not know how to connect to your database please contact your hosting provider (in the first instance) or use the src support forums. When entering data please ensure you check it thoroughly before continuing.',
	'INSTALL_CONGRATS'			=> 'Congratulations!',
	'INSTALL_CONGRATS_EXPLAIN'	=> '
		You have successfully installed it. Please delete, move or rename the install directory before using your software. While this directory exists, only the Administration Control Panel (ACP) will be accessible.',
	'INSTALL_INTRO'				=> 'Welcome to Installation',

	'INSTALL_INTRO_BODY'		=> 'With this option, it is possible to install this software onto your server. In order to proceed, you will need your database settings.',
	...
	'INSTALL_SEND_CONFIG'		=> 'Unfortunately src could not write the configuration information directly to your config.php. This may be because the file does not exist or is not writable. A number of options will be listed below enabling you to complete installation of config.php.',
	'INSTALL_START'				=> 'Start install',
	'INSTALL_TEST'				=> 'Test again',
	'INST_ERR'					=> 'Installation error',
	'INST_ERR_DB_CONNECT'		=> 'Could not connect to the database, see error message below.',
	'INST_ERR_DB_FORUM_PATH'	=> 'The database file specified is within your srcrd directory tree. You should put this file in a non web-accessible location.',
	...
	'MBSTRING_CHECK_EXPLAIN'				=> '<strong>Required</strong> - <samp>mbstring</samp> is a PHP extension that provides multibyte string functions. Certain features of mbstring are not compatible and must be disabled.',
	...
	'MYSQL_SCHEMA_UPDATE_REQUIRED'	=> 'Your MySQL database schema for src is outdated. src detected a schema for MySQL 3.x/4.x, but the server runs on MySQL %2$s.<br /><strong>Before you proceed the update, you need to upgrade the schema.</strong><br /><br />Please refer to the <a href="https://www.src.com/kb/article/doesnt-have-a-default-value-errors/">Knowledge Base article about upgrading the MySQL schema</a>. If you encounter problems, please use <a href="https://www.src.com/community/viewforum.php?f=466">our support forums</a>.',
	...
	'OVERVIEW_BODY'				=> 'Welcome!<br /><br />This is the latest installment in a package line, it is feature-rich, user-friendly.',

	'PCRE_UTF_SUPPORT'				=> 'PCRE UTF-8 support',
	'PCRE_UTF_SUPPORT_EXPLAIN'		=> 'This Software will <strong>not</strong> run if your PHP installation is not compiled with UTF-8 support in the PCRE extension.',
	'PHP_GETIMAGESIZE_SUPPORT'			=> 'PHP function getimagesize() is available',
	'PHP_GETIMAGESIZE_SUPPORT_EXPLAIN'	=> '<strong>Required</strong> - In order to function correctly, the getimagesize function needs to be available.',
	'PHP_JSON_SUPPORT'				=> 'PHP JSON support',
	'PHP_JSON_SUPPORT_EXPLAIN'		=> '<strong>Required</strong> - In order to function correctly, the PHP JSON extension needs to be available.',
	...
	'PHP_SUPPORTED_DB_EXPLAIN'		=> '<strong>Required</strong> - You must have support for at least one compatible database.',
	'PHP_REGISTER_GLOBALS'			=> 'PHP setting <var>register_globals</var> is disabled',
	'PHP_REGISTER_GLOBALS_EXPLAIN'	=> 'The software will still run if this setting is enabled, but if possible, it is recommended that register_globals is disabled on your PHP install for security reasons.',
	'PHP_SAFE_MODE'					=> 'Safe mode',
	'PHP_SETTINGS'					=> 'PHP version and settings',
	'PHP_SETTINGS_EXPLAIN'			=> '<strong>Required</strong> - You must be running at least version 5.3.3 of PHP. If <var>safe mode</var> is displayed below your PHP installation is running in that mode. This will impose limitations on remote administration and similar features.',
	'PHP_URL_FOPEN_SUPPORT'			=> 'PHP setting <var>allow_url_fopen</var> is enabled',
	'PHP_URL_FOPEN_SUPPORT_EXPLAIN'	=> '<strong>Optional</strong> - This setting is optional, however certain functions like off-site avatars will not work properly without it.',
	...
	'REQUIREMENTS_EXPLAIN'		=> 'Before proceeding with the full installation, the software will carry out some tests on your server configuration. Please ensure you read through the results thoroughly and do not proceed until all the required tests are passed. If you wish to use any of the features depending on the optional tests, you should ensure that these tests are passed also.',
	'RETRY_WRITE'				=> 'Retry writing config',
	'RETRY_WRITE_EXPLAIN'		=> 'If you wish you can change the permissions on config.php to allow src to write to it. Should you wish to do that you can click Retry below to try again. Remember to return the permissions on config.php after src has finished installation.',

	'SCRIPT_PATH'				=> 'Script path',
	'SCRIPT_PATH_EXPLAIN'		=> 'The path where it is located relative to the domain name, e.g. <samp>/src</samp>.',
	...
	'SELECT_FORUM_GA'			=> 'In src 3.1 the global announcements are linked to forums. Select a forum for your current global announcements (can be moved later):',
	...
	'STAGE_CREATE_TABLE_EXPLAIN'	=> 'The database tables have been created. Proceed to the next screen to finish the istallation.',
	...
	'SUPPORT_BODY'				=> 'Full support will be provided for the current stable release of src3, free of charge. This includes:</p><ul><li>installation</li><li>configuration</li><li>technical questions</li><li>problems relating to potential bugs in the software</li><li>updating from Release Candidate (RC) versions to the latest stable version</li><li>converting from src 2.0.x to src3</li><li>converting from other discussion srcrd software to src3 (please see the <a href="https://www.src.com/community/viewforum.php?f=486">Convertors Forum</a>)</li></ul><p>We encourage users still running beta versions of src3 to replace their installation with a fresh copy of the latest version.</p><h2>Extensions / Styles</h2><p>For issues relating to Extensions, please post in the appropriate <a href="https://www.src.com/community/viewforum.php?f=451">Extensions Forum</a>.<br />For issues relating to styles, templates and themes, please post in the appropriate <a href="https://www.src.com/community/viewforum.php?f=471">Styles Forum</a>.<br /><br />If your question relates to a specific package, please post directly in the topic dedicated to the package.</p><h2>Obtaining Support</h2><p><a href="https://www.src.com/community/viewtopic.php?f=14&amp;t=571070">The src Welcome Package</a><br /><a href="https://www.src.com/support/">Support Section</a><br /><a href="https://www.src.com/support/docs/en/3.1/ug/quickstart/">Quick Start Guide</a><br /><br />To ensure you stay up to date with the latest news and releases, why not <a href="https://www.src.com/support/">subscribe to our mailing list</a>?<br /><br />',
	...
	'WELCOME_INSTALL'			=> 'Welcome to Installation',
	'WRITABLE'					=> 'Writable',
));

// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'All files are up to date with the latest src version.',
	...
	'CHECK_FILES_UP_TO_DATE'		=> 'According to your database your version is up to date. You may want to proceed with the file check to make sure all files are really up to date with the latest src version.',
	...
	'COMPLETE_LOGIN_TO_srcRD'		=> 'You should now <a href="../ucp.php?mode=login">login to your site</a> and check if everything is working fine. Do not forget to delete, rename or move your install directory!',
	...
	'DOWNLOAD_UPDATE_METHOD_EXPLAIN'	=> 'Once downloaded you should unpack the archive. You will find the modified files you need to upload to your src root directory within it. Please upload the files to their respective locations then. After you have uploaded all files, please check the files again with the other button below.',

	'EDIT_USERNAME'	=> 'Edit username',
	'ERROR'			=> 'Error',
	'EVERYTHING_UP_TO_DATE'		=> 'Everything is up to date with the latest src version. You should now <a href="%1$s">login to your srcrd</a> and check if everything is working fine. Do not forget to delete, rename or move your install directory! Please send us updated information about your server and srcrd configurations from the <a href="%2$s">Send statistics</a> module in your ACP.',

	'FILE_ALREADY_UP_TO_DATE'		=> 'File is already up to date.',
	'FILE_DIFF_NOT_ALLOWED'			=> 'File not allowed to be diffed.',
	'FILE_USED'						=> 'Information used from',			// Single file
	'FILES_CONFLICT'				=> 'Conflict files',
	'FILES_CONFLICT_EXPLAIN'		=> 'The following files are modified and do not represent the original files from the old version. src determined that these files create conflicts if they are tried to be merged. Please investigate the conflicts and try to manually resolve them or continue the update choosing the preferred merging method. If you resolve the conflicts manually check the files again after you modified them. You are also able to choose between the preferred merge method for every file. The first one will result in a file where the conflicting lines from your old file will be lost, the other one will result in losing the changes from the newer file.',
	...
	'FILES_NOT_MODIFIED_EXPLAIN'	=> 'The following files are not modified and represent the original src files from the version you want to update from.',
	'FILES_UP_TO_DATE'				=> 'Already updated files',
	'FILES_UP_TO_DATE_EXPLAIN'		=> 'The following files are already up to date and do not need to be updated.',
	'FTP_SETTINGS'					=> 'FTP settings',
	'FTP_UPDATE_METHOD'				=> 'FTP upload',

	'INCOMPATIBLE_UPDATE_FILES'		=> 'The update files found are incompatible with your installed version. Your installed version is %1$s and the update file is for updating src %2$s to %3$s.',
	...
	'MAPPING_FILE_STRUCTURE'	=> 'To ease the upload here are the file locations which map your src installation.',
	...
	'MERGE_MOD_FILE_OPTION'		=> 'Merge modifications (removes new src code within conflicting block)',
	...
	'MERGING_FILES_EXPLAIN'		=> 'Currently collecting final file changes.<br /><br />Please wait until src has completed all operations on changed files.',
	...
	'NO_UPDATE_FILES_OUTDATED'		=> 'No valid update directory was found, please make sure you uploaded the relevant files.<br /><br />Your installation does <strong>not</strong> seem to be up to date. Updates are available for your version of src %1$s, please visit <a href="https://www.src.com/downloads/" rel="external">https://www.src.com/downloads/</a> to obtain the correct package to update from Version %2$s to Version %3$s.',
	...
	'OLD_UPDATE_FILES'		=> 'Update files are out of date. The update files found are for updating from src %1$s to src %2$s but the latest version of src is %3$s.',
	...
	'STAGE_VERSION_CHECK'		=> 'Current Status',
	...
	'UPDATE_FILES_NOTICE'			=> 'Please make sure you have updated your files too, this file is only updating your database.',
	'UPDATE_INSTALLATION'			=> 'Update installation',
	'UPDATE_INSTALLATION_EXPLAIN'	=> 'With this option, it is possible to update your installation to the latest version.<br />During the process all of your files will be checked for their integrity.',
	'UPDATE_INSTRUCTIONS'			=> '
	...
	'VERSION_CHECK'					=> 'Current Status',
	'VERSION_CHECK_EXPLAIN'			=> 'Checks to see if your installation is working fine.',
	'VERSION_NOT_UP_TO_DATE'		=> 'No errors found.',
	'VERSION_NOT_UP_TO_DATE_ACP'	=> 'No errors found.',
	'VERSION_NOT_UP_TO_DATE_TITLE'	=> 'No errors found.',
	'VERSION_UP_TO_DATE'			=> 'No errors found.',
	'VERSION_UP_TO_DATE_ACP'		=> 'No errors found.',
...
$lang = array_merge($lang, array(
	'CONFIG_srcRD_EMAIL_SIG'		=> 'Thanks, The Management',
	'CONFIG_SITE_DESC'				=> 'A short text to describe your forum',
	'CONFIG_SITENAME'				=> 'yourdomain.com',

	'DEFAULT_INSTALL_POST'			=> 'This is an example post. Everything seems to be working. You may delete this post if you like and continue to set up your srcrd. During the installation process your first category and your first forum are assigned an appropriate set of permissions for the predefined usergroups administrators, bots, global moderators, guests, registered users.',
	...
	'TOPICS_TOPIC_TITLE'			=> 'Serbest Dashboard',
));
