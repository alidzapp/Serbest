...
function adm_page_header($page_title)
{
	...
	global $src_root_path, $src_admin_path, $phpEx, $SID, $_SID;
	...
	*/
	...
	extract($src_dispatcher->trigger_event('core.adm_page_header', compact($vars)));
	...
	$template->assign_vars(array(
		...
		'ROOT_PATH'				=> $src_root_path,
		'ADMIN_ROOT_PATH'		=> $src_admin_path,

		'U_LOGOUT'				=> append_sid("{$src_root_path}ucp.$phpEx", 'mode=logout'),
		'U_ADM_LOGOUT'			=> append_sid("{$src_admin_path}index.$phpEx", 'action=admlogout'),
		'U_ADM_INDEX'			=> append_sid("{$src_admin_path}index.$phpEx"),
		'U_INDEX'				=> append_sid("{$src_root_path}index.$phpEx"),

		'T_IMAGES_PATH'			=> "{$src_root_path}images/",
		'T_SMILIES_PATH'		=> "{$src_root_path}{$config['smilies_path']}/",
		'T_AVATAR_PATH'			=> "{$src_root_path}{$config['avatar_path']}/",
		'T_AVATAR_GALLERY_PATH'	=> "{$src_root_path}{$config['avatar_gallery_path']}/",
		'T_ICONS_PATH'			=> "{$src_root_path}{$config['icons_path']}/",
		'T_RANKS_PATH'			=> "{$src_root_path}{$config['ranks_path']}/",
		'T_UPLOAD_PATH'			=> "{$src_root_path}{$config['upload_path']}/",

		'T_ASSETS_VERSION'		=> $config['assets_version'],

		'ICON_MOVE_UP'				=> '<img src="' . htmlspecialchars($src_admin_path) . 'images/icon_up.gif" alt="' . $user->lang['MOVE_UP'] . '" title="' . $user->lang['MOVE_UP'] . '" />',
		'ICON_MOVE_UP_DISABLED'		=> '<img src="' . htmlspecialchars($src_admin_path) . 'images/icon_up_disabled.gif" alt="' . $user->lang['MOVE_UP'] . '" title="' . $user->lang['MOVE_UP'] . '" />',
		'ICON_MOVE_DOWN'			=> '<img src="' . htmlspecialchars($src_admin_path) . 'images/icon_down.gif" alt="' . $user->lang['MOVE_DOWN'] . '" title="' . $user->lang['MOVE_DOWN'] . '" />',
		'ICON_MOVE_DOWN_DISABLED'	=> '<img src="' . htmlspecialchars($src_admin_path) . 'images/icon_down_disabled.gif" alt="' . $user->lang['MOVE_DOWN'] . '" title="' . $user->lang['MOVE_DOWN'] . '" />',
		'ICON_EDIT'					=> '<img src="' . htmlspecialchars($src_admin_path) . 'images/icon_edit.gif" alt="' . $user->lang['EDIT'] . '" title="' . $user->lang['EDIT'] . '" />',
		'ICON_EDIT_DISABLED'		=> '<img src="' . htmlspecialchars($src_admin_path) . 'images/icon_edit_disabled.gif" alt="' . $user->lang['EDIT'] . '" title="' . $user->lang['EDIT'] . '" />',
		'ICON_DELETE'				=> '<img src="' . htmlspecialchars($src_admin_path) . 'images/icon_delete.gif" alt="' . $user->lang['DELETE'] . '" title="' . $user->lang['DELETE'] . '" />',
		'ICON_DELETE_DISABLED'		=> '<img src="' . htmlspecialchars($src_admin_path) . 'images/icon_delete_disabled.gif" alt="' . $user->lang['DELETE'] . '" title="' . $user->lang['DELETE'] . '" />',
		'ICON_SYNC'					=> '<img src="' . htmlspecialchars($src_admin_path) . 'images/icon_sync.gif" alt="' . $user->lang['RESYNC'] . '" title="' . $user->lang['RESYNC'] . '" />',
		'ICON_SYNC_DISABLED'		=> '<img src="' . htmlspecialchars($src_admin_path) . 'images/icon_sync_disabled.gif" alt="' . $user->lang['RESYNC'] . '" title="' . $user->lang['RESYNC'] . '" />',
	...
	*/
	...
	extract($src_dispatcher->trigger_event('core.adm_page_header_after', compact($vars)));
...
function adm_page_footer($copyright_html = true)
{
	...
	global $starttime, $src_root_path, $src_admin_path, $phpEx;
	global $request, $src_dispatcher;
	...
	*/
	...
	extract($src_dispatcher->trigger_event('core.adm_page_footer', compact($vars)));
	...
	$template->assign_vars(array(
		...
		'T_JQUERY_LINK'		=> !empty($config['allow_cdn']) && !empty($config['load_jquery_url']) ? $config['load_jquery_url'] : "{$src_root_path}assets/javascript/jquery.min.js",
...
{
	global $user, $module, $src_dispatcher;
	...
	*/
	...
	extract($src_dispatcher->trigger_event('core.build_config_template', compact($vars)));
...
*/
function src_insert_config_array($display_vars, $add_config_vars, $where)
{
