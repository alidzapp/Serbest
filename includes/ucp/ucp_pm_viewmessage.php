...
function view_message($id, $mode, $folder_id, $msg_id, $folder, $message_row)
{
	...
	$msg_data = array(
		...
		'U_AUTHOR_POSTS'	=> ($config['load_search'] && $auth->acl_get('u_search')) ? append_sid("{$src_root_path}search.$phpEx", "author_id=$author_id&amp;sr=posts") : '',
		...
		'U_REPORT'			=> ($config['allow_pm_report']) ? append_sid("{$src_root_path}report.$phpEx", "pm=" . $message_row['msg_id']) : '',
