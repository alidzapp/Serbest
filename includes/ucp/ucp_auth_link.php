...
class ucp_auth_link
{
	...
	*/
	...
	{
		global $request, $template, $src_container, $user;
		...
		if (!sizeof($error) && $submit)
		{
			...
			if (!sizeof($error))
			{
				...
				$link_data = $request->get_super_global(\src\request\request_interface::POST);
				...
				if ($request->variable('link', 0, false, \src\request\request_interface::POST))
				{
