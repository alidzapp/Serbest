...
class ucp_pm
{
	...
	{
		global $user, $template, $src_root_path, $auth, $phpEx, $db, $config, $request;
		...
		switch ($mode)
		{
			...
			case 'compose':
				...
				include($src_root_path . 'includes/ucp/ucp_pm_compose.' . $phpEx);
			...
			case 'options':
				...
				include($src_root_path . 'includes/ucp/ucp_pm_options.' . $phpEx);
			...
			case 'drafts':
				...
				include($src_root_path . 'includes/ucp/ucp_main.' . $phpEx);
			...
			case 'view':
				...
				{
					include($src_root_path . 'includes/ucp/ucp_pm_viewfolder.' . $phpEx);
				...
				else if ($action == 'view_message')
				{
					...
					include($src_root_path . 'includes/ucp/ucp_pm_viewmessage.' . $phpEx);
