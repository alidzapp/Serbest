...
class src_questionnaire_data_collector
{
	var $providers;
	var $data = null;
	var $install_id = '';
	...
	* @param	string
	*/
	function src_questionnaire_data_collector($install_id)
	{
...
*/
class src_questionnaire_php_data_provider
{
...
*/
class src_questionnaire_system_data_provider
{
	function get_identifier()
	{
		return 'System';
...
/**
* Questionnaire src data provider
*/
class src_questionnaire_src_data_provider
{
	var $config;
	var $unique_id;
	...
	* @param	array	$config
	*/
	function src_questionnaire_src_data_provider($config)
	{
	...
	*/
	...
	/**
	* Get data about this src installation.
	*
	* @return	array	Relevant anonymous config options
	*/
	function get_data()
	{
		global $src_root_path, $phpEx, $src_config_php_file;
		...
		$config_vars = array(
			...
			'srcrd_email_form' => true,
			'srcrd_hide_emails' => true,
			'srcrd_timezone' => true,
			'browser_check' => true,
			'bump_interval' => true,
			'bump_type' => true,
