...
class acp_logs
{
	...
	function main($id, $mode)
	{
		...
		$deletemark = $request->variable('delmarked', false, false, \src\request\request_interface::POST);
		$deleteall	= $request->variable('delall', false, false, \src\request\request_interface::POST);
		...
		if (($deletemark || $deleteall) && $auth->acl_get('a_clearlogs'))
		{
			if (confirm_box(true))
			{
				...
				$src_log->delete($mode, $conditions);
			}
			else
			{
