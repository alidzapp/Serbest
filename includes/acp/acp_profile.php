...
class acp_profile
{
	...
	function main($id, $mode)
	{
		...
		global $src_root_path, $src_admin_path, $phpEx, $table_prefix;
		...
		$this->type_collection = $src_container->get('profilefields.type_collection');
		...
		switch ($action)
		{
			case 'delete':
				...
				if (confirm_box(true))
				{
					...
					$db_tools = $src_container->get('dbal.tools');
	...
	*/
	...
	{
		global $user, $config, $db, $src_container;
	...
	*/
	...
	{
		global $db, $config, $user, $src_container;
