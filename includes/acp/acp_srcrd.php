...
class acp_srcrd
{
	...
	function main($id, $mode)
	{
		...
		global $cache, $src_container, $src_dispatcher;
		...
		*/
		switch ($mode)
		{
			case 'settings':
				$display_vars = array(
					'title'	=> 'ACP_srcRD_SETTINGS',
					'vars'	=> array(
						'legend1'				=> 'ACP_srcRD_SETTINGS',
						...
						'srcrd_index_text'		=> array('lang' => 'srcRD_INDEX_TEXT',		'validate' => 'string',	'type' => 'text:40:255', 'explain' => true),
						'srcrd_disable'			=> array('lang' => 'DISABLE_srcRD',			'validate' => 'bool',	'type' => 'custom', 'method' => 'srcrd_disable', 'explain' => true),
						'srcrd_disable_msg'		=> false,
						'default_lang'			=> array('lang' => 'DEFAULT_LANGUAGE',		'validate' => 'lang',	'type' => 'select', 'function' => 'language_select', 'params' => array('{CONFIG_VALUE}'), 'explain' => false),
						'default_dateformat'	=> array('lang' => 'DEFAULT_DATE_FORMAT',	'validate' => 'string',	'type' => 'custom', 'method' => 'dateformat_select', 'explain' => true),
						'srcrd_timezone'		=> array('lang' => 'SYSTEM_TIMEZONE',		'validate' => 'timezone',	'type' => 'custom', 'method' => 'timezone_select', 'explain' => true),
			...
			case 'features':
				$display_vars = array(
					'title'	=> 'ACP_srcRD_FEATURES',
					'vars'	=> array(
						'legend1'				=> 'ACP_srcRD_FEATURES',
						'allow_privmsg'			=> array('lang' => 'srcRD_PM',				'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
			...
			case 'avatar':
				...
				$avatar_drivers = $src_avatar_manager->get_all_drivers();

				$avatar_vars = array();
				foreach ($avatar_drivers as $current_driver)
				{
					$driver = $src_avatar_manager->get_driver($current_driver, false);
					...
					* might have.
					*/
					$avatar_vars += $src_avatar_manager->get_avatar_settings($driver);
			...
			case 'email':
				$display_vars = array(
					...
					'vars'	=> array(
						...
						'srcrd_email_form'		=> array('lang' => 'srcRD_EMAIL_FORM',		'validate' => 'bool',	'type' => 'radio:enabled_disabled', 'explain' => true),
						'email_function_name'	=> array('lang' => 'EMAIL_FUNCTION_NAME',	'validate' => 'string',	'type' => 'text:20:50', 'explain' => true),
						'email_package_size'	=> array('lang' => 'EMAIL_PACKAGE_SIZE',	'validate' => 'int:0',	'type' => 'number:0:99999', 'explain' => true),
						'srcrd_contact'			=> array('lang' => 'CONTACT_EMAIL',			'validate' => 'email',	'type' => 'email:25:100', 'explain' => true),
						'srcrd_contact_name'	=> array('lang' => 'CONTACT_EMAIL_NAME',	'validate' => 'string',	'type' => 'text:25:50', 'explain' => true),
						'srcrd_email'			=> array('lang' => 'ADMIN_EMAIL',			'validate' => 'email',	'type' => 'email:25:100', 'explain' => true),
						'srcrd_email_sig'		=> array('lang' => 'EMAIL_SIG',				'validate' => 'string',	'type' => 'textarea:5:30', 'explain' => true),
						'srcrd_hide_emails'		=> array('lang' => 'srcRD_HIDE_EMAILS',		'validate' => 'bool',	'type' => 'radio:yes_no', 'explain' => true),
		...
		/**
		* Event to add and/or modify acp_srcrd configurations
		*
		* @event core.acp_srcrd_config_edit_add
		...
		*/
		...
		extract($src_dispatcher->trigger_event('core.acp_srcrd_config_edit_add', compact($vars)));
		...
		if ($mode == 'auth')
		{
			...
			$auth_providers = $src_container->get('auth.provider_collection');

			$updated_auth_settings = false;
			$old_auth_config = array();
			foreach ($auth_providers as $provider)
			{
				/** @var \src\auth\provider\provider_interface $provider */
	...
	*/
	function select_auth_method($selected_method, $key = '')
	{
		...
		{
			if (!($value instanceof \src\auth\provider\provider_interface))
			{
				continue;
			}
	...
	*/
	...
	/**
	* srcrd disable option and message
	*/
	function srcrd_disable($value, $key)
	{
		global $user;

		$radio_ary = array(1 => 'YES', 0 => 'NO');

		return h_radio('config[srcrd_disable]', $radio_ary, $value) . '<br /><input id="' . $key . '" type="text" name="config[srcrd_disable_msg]" maxlength="255" size="40" value="' . $this->new_config['srcrd_disable_msg'] . '" />';
	}
	...
	*/
	function timezone_select($value, $key)
	{
		...
		$timezone_select = src_timezone_select($template, $user, $value, true);
	...
	*/
	function dateformat_select($value, $key)
	{
		...
		try
		{
			$user->timezone = new DateTimeZone($config['srcrd_timezone']);
		}
		catch (\Exception $e)
		{
			// If the srcrd timezone is invalid, we just use the users timezone.
		}
	...
	*/
	function select_news_forums($value, $key)
	{
		...
		{
			$f_row['selected'] = src_optionget(FORUM_OPTION_FEED_NEWS, $f_row['forum_options']);
	...
	function select_exclude_forums($value, $key)
	{
		...
		foreach ($forum_list as $f_id => $f_row)
		{
			$f_row['selected'] = src_optionget(FORUM_OPTION_FEED_EXCLUDE, $f_row['forum_options']);
