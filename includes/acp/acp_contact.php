...
class acp_contact
{
	...
	public function main($id, $mode)
	{
		...
		global $config, $src_root_path, $phpEx, $src_container;

		$user->add_lang(array('acp/srcrd', 'posting'));
		...
		$config_text = $src_container->get('config_text');
		...
		$template->assign_vars(array(
			...
			'BBCODE_STATUS'			=> $user->lang('BBCODE_IS_ON', '<a href="' . append_sid("{$src_root_path}faq.$phpEx", 'mode=bbcode') . '">', '</a>'),
