 ...
 */
src.addAjaxCallback('row_down', function(res) {
...
src.addAjaxCallback('row_up', function(res) {
	if (typeof res.success === 'undefined' || !res.success) {
		return;
	}
 ...
 */
src.addAjaxCallback('activate_deactivate', function(res) {
	var $this = $(this),
 ...
 */
src.addAjaxCallback('row_delete', function(res) {
...
*/
$(function() {
	src.resizeTextArea($('textarea:not(.no-auto-resize)'), {minHeight: 75});
});
