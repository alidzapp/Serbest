...
function parse_document(container) 
{
	...
	*/
	container.find('#tabs').not('[data-skip-responsive]').each(function() {
		...
		src.registerDropdown(item.find('a.responsive-tab-link'), item.find('.dropdown'), {visibleClass: 'activetab', verticalDirection: 'down'});
...
(function($) {
	$(document).ready(function() {
		...
		src.toggleDisplay('configlist', -1);
		src.toggleDisplay('questionnaire-thanks', -1);
	});
})(jQuery);
